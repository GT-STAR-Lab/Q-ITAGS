...
namespace grstapse
{
    ...
    class Task
    {
       public:
        ...
        Task(const std::shared_ptr<SasAction>& symbolic_action,
             ...
             const Eigen::VectorXf& linear_coefficients = Eigen::VectorXf());
        ...
        //! \returns The linear quality coefficients for the task
        [[nodiscard]] inline const Eigen::VectorXf& linearCoefficients() const;
       ...
       private:
        ...
        Eigen::VectorXf m_linear_coefficients;
    ...
    const Eigen::VectorXf& Task::linearCoefficients() const
    {
        return m_linear_coefficients;
    }
