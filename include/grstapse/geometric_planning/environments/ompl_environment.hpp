...
namespace grstapse
{
    ...
    OmplEnvironmentType OmplEnvironment::omplEnvironmentType() const
    {
...
{
    template <>
    struct adl_serializer<std::shared_ptr<grstapse::OmplEnvironment>>
    {
        //! Non-default constructable from_json
        static std::shared_ptr<grstapse::OmplEnvironment> from_json(const json& j);
    };
}  // namespace nlohmann