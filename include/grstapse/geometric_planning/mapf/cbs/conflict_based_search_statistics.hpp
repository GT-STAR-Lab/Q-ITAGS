...
namespace grstapse
{
    ...
    class ConflictBasedSearchStatistics : public SearchStatisticsBase
    {
       public:
        //! Constructor
        explicit ConflictBasedSearchStatistics(const std::string& timer_name)
            : SearchStatisticsBase(timer_name)
            , m_high_level_nodes_generated(0)
            , m_high_level_nodes_evaluated(0)
            , m_high_level_nodes_expanded(0)
            , m_total_time(0.0f)
            , m_low_level_nodes_generated(0)
            , m_low_level_nodes_evaluated(0)
            , m_low_level_nodes_expanded(0)
            , m_low_level_nodes_deadends(0)
            , m_low_level_nodes_pruned(0)
            , m_low_level_time(0.0f)
        {}
        ...
        //! \copydoc SearchStatisticsBase
        nlohmann::json serializeToJson(const std::shared_ptr<const ProblemInputs>& problem_inputs) const override;
