...
{
    /*!
     * \brief A goal check based on a node being close to the goal configuration
     *
     * \tparam SearchNode
     */
    template <typename SearchNode>
    class EqualEuclideanGraphConfigurationGoalCheck : public GoalCheckBase<SearchNode>
    {
       public:
        //! Constructor
        explicit EqualEuclideanGraphConfigurationGoalCheck(
