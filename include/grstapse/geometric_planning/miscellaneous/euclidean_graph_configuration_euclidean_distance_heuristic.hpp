...
{
    /*!
     * \brief A heuristic that uses euclidean distance to the goal
     *
     * \tparam UndirectedGraphSearchNodeDeriv
     *
     * \todo static check that PointGraphConfiguration is the VertexPayload
     */
    template <typename UndirectedGraphSearchNodeDeriv>
    class EuclideanGraphConfigurationEuclideanDistanceHeuristic : public HeuristicBase<UndirectedGraphSearchNodeDeriv>
    {
       public:
        //! Constructor
        explicit EuclideanGraphConfigurationEuclideanDistanceHeuristic(
       ...
       private:
        std::shared_ptr<const EuclideanGraphConfiguration> m_goal;
    };
