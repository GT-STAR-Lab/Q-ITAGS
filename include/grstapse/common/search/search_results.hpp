...
namespace grstapse
{
    ...
    class SearchResults
    {
       public:
        ...
        void writeToFile(const std::string& filepath, const std::shared_ptr<const ProblemInputs>& problem_inputs) const
        {
            nlohmann::json j;
            j[constants::k_solution]   = m_goal->serializeToJson(problem_inputs);
