...
{
    /*!
     * \brief Name scheme for the DeterministicMilpSubscheduler
     *
     * \see DeterministicMilpSubscheduler
     */
    class SubschedulerNameScheme : public DmsNameSchemeBase
    {
       public:
        //! Constructor
        explicit SubschedulerNameScheme(unsigned int index);
        ...
        [[nodiscard]] std::string createTransitionDurationVariableName(unsigned int i,
                                                                       unsigned int j) const final override;
