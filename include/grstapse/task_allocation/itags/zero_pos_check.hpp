...
namespace grstapse
{
    ...
    //! \brief Checks that a schedule satisfies the desired schedule max
    class ZeroPosCheck : public GoalCheckBase<IncrementalTaskAllocationNode>
    {
       public:
        /*!
         * \brief Constructor
         ...
         */
        explicit ZeroPosCheck(const std::shared_ptr<const ItagsProblemInputs>& problem_inputs);
        ...
        float computeMakespan(IncrementalTaskAllocationNode* node) const;
