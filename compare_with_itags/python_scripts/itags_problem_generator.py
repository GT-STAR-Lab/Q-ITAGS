...
num_agent_min = 5
num_agent_max = 6
num_type_robot_min = [1, 1, 1, 1, 1, 0]
num_type_robot_max = [6, 6, 6, 6, 6, 0]
...
file = "/../../data/problem_inputs/ICRA/Initial_comp/"
base_loc = "../Problems/base_survivor_domain.json"

# PGM files denoting locations where task/agent can be placed
agent_loc_pgm = "../../data/geometric_planning/maps/empty"
task_loc_pgm = "../../data/geometric_planning/maps/empty"
