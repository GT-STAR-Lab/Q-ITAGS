...
namespace nlohmann
{
    std::shared_ptr<const grstapse::Se3StateOmplConfiguration>
    adl_serializer<std::shared_ptr<const grstapse::Se3StateOmplConfiguration>>::from_json(const json& j)
    {
        return adl_serializer<std::shared_ptr<grstapse::Se3StateOmplConfiguration>>::from_json(j);
    }

    std::shared_ptr<grstapse::Se3StateOmplConfiguration>
    adl_serializer<std::shared_ptr<grstapse::Se3StateOmplConfiguration>>::from_json(const json& j)
    {
        ...
        const float z  = j.at(grstapse::constants::k_z);
        const float qw = j.at(grstapse::constants::k_qw);
        const float qx = j.at(grstapse::constants::k_qx);
        const float qy = j.at(grstapse::constants::k_qy);
        const float qz = j.at(grstapse::constants::k_qz);
        return std::make_shared<grstapse::Se3StateOmplConfiguration>(x, y, z, qw, qx, qy, qz);
    }

    void adl_serializer<std::shared_ptr<const grstapse::Se3StateOmplConfiguration>>::to_json(
        json& j,
        const std::shared_ptr<const grstapse::Se3StateOmplConfiguration>& c)
    {
        ...
        j[grstapse::constants::k_z]                  = c->z();
        j[grstapse::constants::k_qw]                 = c->qw();
        j[grstapse::constants::k_qx]                 = c->qx();
        j[grstapse::constants::k_qy]                 = c->qy();
        j[grstapse::constants::k_qz]                 = c->qz();
    }

    void adl_serializer<std::shared_ptr<grstapse::Se3StateOmplConfiguration>>::to_json(
        json& j,
        const std::shared_ptr<grstapse::Se3StateOmplConfiguration>& c)
    {
        adl_serializer<std::shared_ptr<const grstapse::Se3StateOmplConfiguration>>::to_json(j, c);
    }
