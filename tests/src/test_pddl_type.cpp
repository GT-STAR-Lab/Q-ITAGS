...
namespace grstapse::unittests
{
    TEST(PddlType, empty)
    {
        FileReader reader(std::string(s_data_dir) + std::string("/task_planning/pddl_parser/types/empty.pddl"));
    ...
    {
        FileReader reader(std::string(s_data_dir) + std::string("/task_planning/pddl_parser/types/single.pddl"));
        mocks::MockPddlParser parser;
        parser.createPddlTask();
        parser.pddlTask()->setRequirement("typing");
        reader.checkNext(PddlSymbol::e_open_paren);
    ...
    {
        FileReader reader(std::string(s_data_dir) + std::string("/task_planning/pddl_parser/types/single_parent.pddl"));
        mocks::MockPddlParser parser;
        parser.createPddlTask();
        parser.pddlTask()->setRequirement("typing");
        reader.checkNext(PddlSymbol::e_open_paren);
    ...
    TEST(PddlType, two)
    {
        FileReader reader(std::string(s_data_dir) + std::string("/task_planning/pddl_parser/types/two.pddl"));
        mocks::MockPddlParser parser;
        parser.createPddlTask();
        parser.pddlTask()->setRequirement("typing");
        reader.checkNext(PddlSymbol::e_open_paren);
    ...
    {
        FileReader reader(std::string(s_data_dir) + std::string("/task_planning/pddl_parser/types/two_parent.pddl"));
        mocks::MockPddlParser parser;
        parser.createPddlTask();
        parser.pddlTask()->setRequirement("typing");
        reader.checkNext(PddlSymbol::e_open_paren);
    ...
    {
        FileReader reader(std::string(s_data_dir) + std::string("/task_planning/pddl_parser/types/complex.pddl"));
        mocks::MockPddlParser parser;
        parser.createPddlTask();
        parser.pddlTask()->setRequirement("typing");
        reader.checkNext(PddlSymbol::e_open_paren);
    ...
    TEST(PddlType, unknown_parent)
    {
        FileReader reader(std::string(s_data_dir) +
                          std::string("/task_planning/pddl_parser/types/unknown_parent.pddl"));
        mocks::MockPddlParser parser;
        parser.createPddlTask();
        parser.pddlTask()->setRequirement("typing");
        reader.checkNext(PddlSymbol::e_open_paren);
