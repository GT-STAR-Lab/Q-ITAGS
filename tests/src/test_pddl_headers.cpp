...
namespace grstapse::unittests
{
    ...
    {
        FileReader reader(std::string(s_data_dir) + std::string("/task_planning/pddl_parser/domain_header.pddl"));
    ...
    {
        FileReader reader(std::string(s_data_dir) + std::string("/task_planning/pddl_parser/problem_header.pddl"));
        mocks::MockPddlParser parser;
