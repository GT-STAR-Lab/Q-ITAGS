...
namespace grstapse::unittests
{
    ...
    TEST(AllocationPercentageRemaining, Simple)
    {
        ...
        auto itags_problem_inputs = std::make_shared<mocks::MockItagsProblemInputs>(grstaps_problem_inputs);
        itags_problem_inputs->setDesiredTraitsMatrix(desired_traits_matrix);
