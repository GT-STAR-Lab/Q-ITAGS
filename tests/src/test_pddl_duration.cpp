...
namespace grstapse::unittests
{
    ...
    TEST(PddlDuration, empty)
    {
        FileReader reader(std::string(s_data_dir) +
                          std::string("/task_planning/pddl_parser/durative_actions/duration/empty.pddl"));
    ...
    {
        FileReader reader(std::string(s_data_dir) +
                          std::string("/task_planning/pddl_parser/durative_actions/duration/equal.pddl"));
    ...
    {
        FileReader reader(std::string(s_data_dir) +
                          std::string("/task_planning/pddl_parser/durative_actions/duration/inequality.pddl"));
