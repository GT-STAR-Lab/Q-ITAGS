...
namespace grstapse::unittests
{
    ...
    TEST(RobotTraitsMatrixReduction, LoadMatrixMultiply)
    {
        std::ifstream fin(std::string(s_data_dir) +
                          std::string("/task_allocation/robot_traits_matrix_reduction/matrix_multiply.json"));
        nlohmann::json j;
        fin >> j;
    ...
    {
        std::ifstream fin(std::string(s_data_dir) +
                          std::string("/task_allocation/robot_traits_matrix_reduction/summation.json"));
        nlohmann::json j;
        fin >> j;
        auto reduction = j.get<std::shared_ptr<RobotTraitsMatrixReduction>>();
        Eigen::MatrixXf allocation(2, 2);
    ...
    {
        std::ifstream fin(std::string(s_data_dir) +
                          std::string("/task_allocation/robot_traits_matrix_reduction/product.json"));
        nlohmann::json j;
        fin >> j;
        auto reduction = j.get<std::shared_ptr<RobotTraitsMatrixReduction>>();
        Eigen::MatrixXf allocation(2, 2);
    ...
    {
        std::ifstream fin(std::string(s_data_dir) +
                          std::string("/task_allocation/robot_traits_matrix_reduction/minimum.json"));
        nlohmann::json j;
        fin >> j;
        auto reduction = j.get<std::shared_ptr<RobotTraitsMatrixReduction>>();
        Eigen::MatrixXf allocation(2, 2);
    ...
    {
        std::ifstream fin(std::string(s_data_dir) +
                          std::string("/task_allocation/robot_traits_matrix_reduction/maximum.json"));
        nlohmann::json j;
        fin >> j;
        auto reduction = j.get<std::shared_ptr<RobotTraitsMatrixReduction>>();
        Eigen::MatrixXf allocation(2, 2);
    ...
    {
        std::ifstream fin(std::string(s_data_dir) +
                          std::string("/task_allocation/robot_traits_matrix_reduction/custom.json"));
        nlohmann::json j;
        fin >> j;
        auto reduction = j.get<std::shared_ptr<RobotTraitsMatrixReduction>>();
        Eigen::MatrixXf allocation(2, 2);
    ...
    {
        std::ifstream fin(std::string(s_data_dir) +
                          std::string("/task_allocation/robot_traits_matrix_reduction/one_of_each.json"));
        nlohmann::json j;
        fin >> j;
        auto reduction = j.get<std::shared_ptr<RobotTraitsMatrixReduction>>();
        Eigen::MatrixXf allocation(1, 2);
