...
namespace grstapse::mocks
{
    ...
    class MockGrstapsProblemInputs : public GrstapsProblemInputs
    {
       public:
        //! Constructor
        MockGrstapsProblemInputs()
            : GrstapsProblemInputs(ProblemInputs::s_this_is_protected_tag)
        {}
        ...
        inline void setSpecies(const std::vector<std::shared_ptr<const Species>>& species)
        {
            m_species = species;
        }

        inline void setMotionPlanners(const std::vector<std::shared_ptr<MotionPlannerBase>>& motion_planners)
        {
         ...
         * \note For MilpScheduler tests
         */
        inline void setScheduleParameters(const std::shared_ptr<const ParametersBase>& scheduler_parameters)
        {
