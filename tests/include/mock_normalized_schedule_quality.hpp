...
namespace grstapse::mocks
{
     ...
     */
    class MockNormalizedScheduleQuality : public NormalizedScheduleQuality
    {
       public:
        //! Constructor
       ...
       private:
        [[nodiscard]] float computeMakespan(IncrementalTaskAllocationNode* node) const final override;
